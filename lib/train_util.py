...
def reshape_multiview_tensors(image_tensor_512, image_tensor, calib_tensor):
    ...
    image_tensor_512 = image_tensor_512.view(
        image_tensor_512.shape[0] * image_tensor_512.shape[1],
        image_tensor_512.shape[2],
        image_tensor_512.shape[3],
        image_tensor_512.shape[4]
    )
    ...
    return image_tensor_512, image_tensor, calib_tensor
