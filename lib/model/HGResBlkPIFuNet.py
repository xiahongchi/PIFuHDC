...
from .BasePIFuNetFromPIFu import BasePIFuNetFromPIFu
from .HGFilters import ConvBlock
from ..net_util import *

class HgCater(nn.Module):
    def __init__(self, in_ch, last_ch) -> None:
        super().__init__()
        ...
        self.conv2 = ConvBlock(64, 256, self.norm)
    ...
    def forward(self, hgfeat):
        ...
        out = f.repeat(1, 4, 1, 1)
        """
        
        
        out = self.model(hgfeat)
        return out


class HGResBlkPIFuNet(BasePIFuNetFromPIFu):
    def __init__(self, opt,
                 projection_mode='orthogonal'):

        super(HGResBlkPIFuNet, self).__init__(
        ...
        self.hgcater = HgCater(in_ch=16, last_ch=256) 
    ...
    def attach(self, im_feat):
        self.im_feat = torch.cat([self.hgcater(im_feat), self.im_feat], 1)
